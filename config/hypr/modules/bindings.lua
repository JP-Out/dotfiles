...
bind(mod .. " + Return", hl.dsp.exec_cmd("kitty"), "Abrir terminal")
bind(mod .. " + E", hl.dsp.exec_cmd("dolphin"), "Abrir gerenciador de arquivos")
bind(mod .. " + Space", hl.dsp.exec_cmd("pkill -x rofi || rofi -show drun"), "Alternar menu de aplicativos")
